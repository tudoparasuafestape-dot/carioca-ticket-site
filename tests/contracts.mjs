...
if (produtorSolicitacoes) {
  for (const required of [
    ...
    'REPROVAR',
    'Aprovar e ativar',
    'prepara organização e financeiro pendente',
    'Vendas só são publicadas após o financeiro ficar pronto',
    'Financeiro ainda não liberado para vendas.',
